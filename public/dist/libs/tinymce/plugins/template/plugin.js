...
(function () {
    ...
    const getPreviewContent = (editor, html) => {
        ...
        if (html.indexOf('<html>') === -1) {
            ...
            html = '<!DOCTYPE html>' + '<html>' + '<head>' + '<common href="' + encode(editor.documentBaseURI.getURI()) + '">' + contentCssEntries + preventClicksOnLinksScript + '</head>' + '<body class="' + encode(bodyClass) + '"' + dirAttr + '>' + parseAndSerialize(editor, html) + '</body>' + '</html>';
        }
