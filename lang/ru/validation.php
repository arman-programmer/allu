...
return [
    ...
    */
    ...
    'digits' => 'Поле :attribute должно быть :digits символов.',
    ...
    /*
    |----------------------------------------------------------------- -------------------------
    | Пользовательские языковые строки проверки
    |----------------------------------------------------------------- -------------------------
    |
    | Здесь вы можете указать собственные сообщения проверки для атрибутов, используя
    | соглашение «attribute.rule» для именования строк. Это позволяет быстро
    | укажите конкретную строку пользовательского языка для данного правила атрибута.
    |
    */
    ...
    | вместо этого использовать что-то более удобное для чтения, например «Адрес электронной почты».
